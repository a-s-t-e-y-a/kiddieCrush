...
import sideImage from "../../public/images/sticker_13.png";
import { ArrowRight } from "lucide-react";

function Login() {
  return (
    <div className="bg-amber-100 w-[100vw] h-[100vh] absolute">
      <div className="md:w-[70%] h-[350px] bg-white absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] grid md:grid-cols-2 rounded-md">
        <div className="">
          <Image
            src={sideImage}
            alt="cute relations"
        ...
        <div className="">
          <h1 className="text-2xl my-5 ">Signin</h1>
          <form>
            <div className="w-72">
          ...
          <button className="w-72 my-5 flex border-solid border-white rounded-md border-2 p-2 hover:gap-2 transition transform duration-300 hover:scale-105 group">
              Signup <ArrowRight className="group-hover:hidden"></ArrowRight>
